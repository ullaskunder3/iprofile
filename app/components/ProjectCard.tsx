...
export default function ProjectCard({
  ...
  return (
    <article
      ...
      className="glass animate-in p-6 sm:p-8 md:p-[var(--space-xl)]"
    >
      {/* Header */}
      <header style={{ display: "flex", flexDirection: "column", gap: "var(--space-sm)" }}>
        ...
        <h2
          ...
          style={{
            fontSize: "clamp(1.5rem, 6vw, var(--text-2xl))",
            fontWeight: 700,
            lineHeight: 1.2,
            margin: 0,
          }}
      ...
      <div style={{ display: "flex", gap: "var(--space-sm)", flexWrap: "wrap", marginTop: "auto" }}>
        {liveUrl && status === "live" && (
          <a
            ...
            style={{ padding: "0.5rem 1.25rem", fontSize: "var(--text-xs)", minWidth: "160px", justifyContent: "center" }}
          >
        ...
        {(status === "coming-soon" || status === "in-review") && !liveUrl && (
          <span
            className="btn-outline"
            style={{ cursor: "default", opacity: 0.6, padding: "0.5rem 1.25rem", fontSize: "var(--text-xs)", minWidth: "160px", justifyContent: "center" }}
          >
